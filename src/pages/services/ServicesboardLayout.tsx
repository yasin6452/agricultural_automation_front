...
export const ServicesLayout = () => {
    ...
    const hoverBg = darkMode ? "rgba(255, 255, 255, 0.1)" : "rgba(249, 115, 22, 0.08)";
    const activeBg = darkMode ? "rgba(249, 115, 22, 0.2)" : "#f97316";
    const activeText = darkMode ? "#fdba74" : "#ffffff";
            ...
            <Layout style={{ marginRight: collapsed ? 80 : 280, transition: "margin 0.3s ease-in-out" }}>
                ...
                >
                    <div className="flex items-center gap-4">
                        {/* عنوان */}
                        <div className="flex items-center gap-2">
                            <div className="w-1 h-6 bg-gradient-to-b from-[#f97316] to-[#fb923c] rounded-full"></div>
