// src/pages/services/ServiceSettings.tsx
import { useState } from "react";
import { Card, Form, Input, Button, Switch, message, Tabs, Upload, Select, Alert, Divider, Modal, Rate, InputNumber, Space, ConfigProvider } from "antd";
import {
    SettingOutlined,
    DollarOutlined,
    ClockCircleOutlined,
...
import { Settings as SettingsIcon, Package, DollarSign, Trash2, Clock } from "lucide-react";
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                >
                                                    <Space.Compact style={{ width: '100%' }}>
                                                        ...
                                                        />
                                                        <Button size="large" style={{ height: '40px' }} disabled>
                                                            روز
                                                        </Button>
                                                    </Space.Compact>
                                                </Form.Item>
